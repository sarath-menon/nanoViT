A super simple implementation of Vision Transformer (ViT) in PyTorch. Inspired by Andrej Karpathy's nanoGPT project. The model is a single file with <200 lines of code.
